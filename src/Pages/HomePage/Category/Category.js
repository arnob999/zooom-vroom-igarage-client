        ...
        <div className="mt-8">
            ...
            <div className='mainCard grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3'>
                <div className="card1 h-full">
                    ...
                    <button class="py-2 mt-5 px-4 shadow-md no-underline rounded-full  text-white font-sans font-semibold text-sm border-blue btn-secondary hover:text-white hover:bg-blue-light focus:outline-none active:shadow-none mr-2">Browse More</button>
                </div>
